                                ...
                                <div className="header-element">
                                    <div className="horizontal-logo">
                                        <Link href="/components/dashboard/dashboard" className="header-logo">
                                            ...
                                            <Image  src="../../../assets/images/brand-logos/toggle-white.png" alt="logo" className="toggle-white" />
                                    ...
                                    <div className="landing-logo-container">
                                        <div className="horizontal-logo ps-0">
                                            <Link href="/components/dashboard/dashboard" className="header-logo">
                                                ...
                                                <Image  src="../../../assets/images/brand-logos/desktop-white.png" alt="logo" className="desktop-white" />
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="container px-sm-0 main-banner-container pb-0">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-6 col-lg-6 my-auto text-end">
                                            <Image  src="../../../assets/images/landing/2.png" alt="" className="w-100" />
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <div className="row justify-content-center align-items-center g-0">
                                <div className="col-xxl-5 col-xl-5 col-lg-5 customize-image text-center">
                                    <div className="text-lg-end">
                                        <Image  src="../../../assets/images/landing/1.png" alt="" className="img-fluid" />
                                    </div>
                                </div>
                                    ...
                                    <Swiper centeredSlides={false} autoplay={{ delay: 2500, disableOnInteraction: false, }} modules={[Autoplay]} breakpoints={{
                                        ...
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/9.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Nextjs</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/8.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">React Bootstrap</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/1.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Sass</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/3.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Yarn</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/6.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">NPM</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <Image  src="../../../assets/images/landing/web/5.png" alt="image" className="featur-icon" />
                        ...
                        <section className="section landing-footer">
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-xl-4">
                                        <div className="px-4">
                                            <Link href="/components/dashboard/dashboard"><Image  loading="lazy" alt="" className="logo-2 mb-3" src="../../../assets/images/brand-logos/desktop-logo.png" /></Link>
                                            <Link href="/components/dashboard/dashboard"><Image  src="../../../assets/images/brand-logos/desktop-white.png" className="logo-3 mb-3" alt="logo" /></Link>
