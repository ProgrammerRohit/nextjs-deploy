                                            ...
                                            <div className="">
                                                <Swiper spaceBetween={10} autoplay={{ delay: 2500, disableOnInteraction: false, }} navigation={true}
                                                    ...
                                                    <SwiperSlide id="img-container">
                                                        <Image  className="img-fluid" src="../../../../assets/images/ecommerce/6.png" alt="img" />
                                                    </SwiperSlide>
                                                    <SwiperSlide className="image-container">
                                                        <Image  className="img-fluid" src="../../../../assets/images/ecommerce/7.png" alt="img" />
                                                    </SwiperSlide>
                                                    <SwiperSlide className="image-container">
                                                        <Image  className="img-fluid" src="../../../../assets/images/ecommerce/8.png" alt="img" />
                                                    </SwiperSlide>
                                                    <SwiperSlide className="image-container">
                                                        <Image  className="img-fluid" src="../../../../assets/images/ecommerce/9.png" alt="img" />
                                                    </SwiperSlide>
                                                </Swiper>
                                                ...
                                                <Card.Body>
                                                    <div className="d-flex justify-content-evenly mt-4">
                                                        <div className="">
                                                            <div className="text-center">
                                                                <div className="avatar avatar-xxl bg-light p-1">
                                                                    <Image  src="../../../../assets/images/ecommerce/6.png" alt="" />
                                                                </div>
                                                        ...
                                                        <div className="">
                                                            <div className="text-center">
                                                                <div className="avatar avatar-xxl bg-light p-1">
                                                                    <Image  src="../../../../assets/images/ecommerce/8.png" alt="" />
                                                                </div>
                                                                        ...
                                                                        <div className="col-xl-6">
                                                                            <div className="products-review-images">
                                                                                <Link aria-label="anchor" href="#!;">
                                                                                    <Image  src="../../../../assets/images/ecommerce/11.png" alt="" />
                                                                                </Link>
                                                                                <Link aria-label="anchor" href="#!;">
                                                                                    <Image  src="../../../../assets/images/ecommerce/10.png" alt="" />
                                                                                </Link>
                                                                            </div>
                                                                        </div>
                            ...
                            <Card.Body>
                                <Row>
                                    ...
                                    <Col xl={2} className="col-12 my-2">
                                        <div className="text-center">
                                            <div className="similar-products-image me-2">
                                                <Image  src="../../../../assets/images/ecommerce/7.png" alt="" />
                                            </div>
                                            <h5 className="my-2 fs-14 fw-semibold">Omega Mens Branded Jacket</h5>
                                            <div className="d-flex align-items-center justify-content-center mb-2">
                                    ...
                                    <Col xl={2} className="col-12 my-2">
                                        <div className="text-center">
                                            <div className="similar-products-image me-2">
                                                <Image  src="../../../../assets/images/ecommerce/9.png" alt="" />
                                            </div>
                                            <h5 className="my-2 fs-14 fw-semibold">Omega Mens Branded Jacket</h5>
                                            <div className="d-flex align-items-center justify-content-center mb-2">
                                                <h5 className="mb-0 fw-semibold me-1">
