...
const Tables = () => {
	...
	return (
		<Fragment>
										...
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<a href="#!" className="btn btn-sm text-info"><i className="ri-edit-line"></i></a>
													<a href="#!" className="btn btn-sm text-danger"><i className="ri-delete-bin-line"></i></a>
												</div>
											</td>
										</tr>
									))}
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Table Without Borders" customCardClass="custom-card" customCardBodyClass="p-0" code={table14}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title="Table Group Divideres" customCardClass="custom-card" customCardBodyClass="p-0" code={table15}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Striped rows" customCardClass="custom-card" customCardBodyClass="p-0" code={table3}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title="Striped columns" customCardClass="custom-card" customCardBodyClass="p-0" code={table4}>
						<div className="table-responsive">
							<Table className="table text-nowrap table-striped-columns" striped="columns">
								<thead>
									<tr>
										<th scope="col">ID</th>
										<th scope="col">Date</th>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Hoverable Rows" customCardClass="custom-card" customCardBodyClass="p-0" code={table22}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title=" Hoverable rows With striped rows" customCardClass="custom-card" customCardBodyClass="p-0" code={table23}>
						<div className="table-responsive">
							<Table className="text-nowrap table-striped table-hover" hover striped>
								<thead>
									<tr>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Table Head Primary" customCardClass="custom-card" customCardBodyClass="p-0" code={table16}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
									...
									{Table7data.map((idx) => (
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<a href="#!"
														className="btn btn-sm btn-success-light rounded-pill"><i
															className="ri-download-2-line"></i></a>
													<a href="#!"
														className="btn btn-sm btn-info-light rounded-pill"><i
															className="ri-edit-line"></i></a>
													<a href="#!"
														className="btn btn-sm btn-danger-light rounded-pill"><i
				...
				<Col xl={6}>
					<ShowCode title="Table Head warning" customCardClass="custom-card" customCardBodyClass="p-0" code={table17}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Success" customCardClass="custom-card" customCardBodyClass="p-0" code={table18}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Info" customCardClass="custom-card" customCardBodyClass="p-0" code={table19}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Secondary" customCardClass="custom-card" customCardBodyClass="p-0" code={table20}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Danger" customCardClass="custom-card" customCardBodyClass="p-0" code={table21}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Table Foot" customCardClass="custom-card" customCardBodyClass="p-0" code={table26}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead className="table-primary">
									<tr>
				...
				<Col xl={4}>
					<ShowCode title="Table With Caption" customCardClass="custom-card" customCardBodyClass="p-0" code={table27}>
						<div className="table-responsive ">
							<Table className="table text-nowrap">
				...
				<Col xl={4}>
					<ShowCode title="Table With Top Caption" customCardClass="custom-card" customCardBodyClass="p-0" code={table28}>
						<div className="table-responsive">
								...
								<tbody>
									{Table9data.map((idx) => (
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<a href="#!" className="btn btn-sm btn-light"><i className="ri-download-2-line"></i></a>
													<a href="#!" className="btn btn-sm btn-light"><i className="ri-edit-line"></i></a>
												</div>
											</td>
										</tr>
									))}
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Color variants tables" customCardClass="custom-card" customCardBodyClass="p-0" code={table29}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Always responsive" customCardClass="custom-card" customCardBodyClass="p-0" code={table31}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										...
										<td>
											<div className="hstack gap-2 fs-15">
												<a href="#!" className="btn btn-sm btn-success"><i className="ri-download-2-line"></i></a>
												<a href="#!" className="btn btn-sm btn-info"><i className="ri-edit-line"></i></a>
											</div>
										</td>
									</tr>
									<tr>
