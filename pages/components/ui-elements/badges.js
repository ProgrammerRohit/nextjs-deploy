	...
	return (
		<div >
			...
			<Row>
				...
				<Col xl={6}>
					<ShowCode title="Buttons With Badges2" customCardClass="custom-card" customCardBodyClass="d-flex flex-wrap gap-2" code={badge10}>
						<Button variant='primary' type="button" className=" my-1 me-2">
			...
			<Row>
				...
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Positioned Badges" customCardClass="custom-card" customCardBodyClass="d-flex flex-wrap gap-5" code={badge13}>
						...
						<Col xl={12} className="">
							<ShowCode title="Custom Badges" customCardClass="custom-card" customCardBodyClass="d-flex align-items-center flex-wrap" code={badge14}>
