							...
							<Card className="custom-card">
								...
								<Card.Body className="bd-example-row">
									<p className="mb-4">With the move to flexbox in v4, you can use margin utilities like
										<span className=" text-danger mx-1">.me-auto</span>to force sibling columns
										away
										from one
										another.
									</p>
					...
					<Row>
							...
							<Card className="custom-card">
								...
								<Card.Body className="bd-example-row">
									...
									<p>You may also apply this break at specific breakpoints with our <span
										className=" text-danger mx-1">responsive display utilities.</span></p>
									<div className="container">
										<Row>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body className="bd-example-row">
									...
									<p>There are also responsive <span className=" text-danger mx-1">.order-first</span> and
										<span className=" text-danger mx-1">.order-last</span> classes that change the
										order of an element by applying <span className=" text-danger mx-1">order: -1</span>
										and
										<span className=" text-danger mx-1">order: 6</span>, respectively. These
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body>
									<p>The <span className=" text-danger mx-1">.col-*</span> classes can also be used
										outside a
										<span className=" text-danger mx-1">.row</span> to give an element a specific
					...
					<Card className="custom-card">
						<Card.Body>
							<p>The classes can be used together with utilities to create responsive floated
								images.
								Make sure to wrap the content in a <span className=" text-danger mx-1 mx-1">.clearfix</span>
