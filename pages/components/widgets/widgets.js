                        ...
                        <Col xl={6}>
                            <Card className="custom-card">
                                <Card.Body>
                                    ...
                                    <div className="">
                                        <ProgressBar className="progress progress-xs mb-4" role="progressbar" now={25} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
                                    </div>
                                    ...
                                    <div className="">
                                        <ProgressBar className="progress progress-xs mb-2" role="progressbar" now={75} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
                                    </div>
                                </Card.Body>
                                        ...
                                        <div className="d-flex flex-wrap flex-fill align-items-center justify-content-between">
                                            ...
                                            <Dropdown className="">
                                                ...
                                                <Dropdown.Menu as="ul" className="">
                                                    <Dropdown.Item as="li"><Link className="" href="#!">Action</Link></Dropdown.Item>
                                                    <Dropdown.Item as="li"><Link className="" href="#!">Another action</Link></Dropdown.Item>
                                                    <Dropdown.Item as="li"><Link className="" href="#!">Something else here</Link></Dropdown.Item>
                                                </Dropdown.Menu>
                                            </Dropdown>
                                        </div>
                                    </div>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="table-responsive">
                                <Table className="table table-bordered table-hover text-nowrap traffic-source">
                                    <thead>
                                        <tr>
                                            <th>Browser</th>
                                            <th>Sessions</th>
