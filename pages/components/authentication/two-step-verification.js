                                ...
                                <Col xl={12} className="mb-2">
                                    ...
                                    <div className="form-check  mt-2">
                                        ...
                                        <Form.Label className="form-check-label" htmlFor="defaultCheck1">
                                            Did not recieve a code ?<Link href="/components/pages/email/mail-inbox/" className="text-primary ms-2">Resend</Link>
                                        </Form.Label>
                                    </div>
                                </Col>
                                <Col xl={12} className="d-grid mt-2">
                                    <Link href={"/components/dashboard/dashboard"} className="btn btn-lg btn-primary">Verify</Link>
                                </Col>
                            </div>
