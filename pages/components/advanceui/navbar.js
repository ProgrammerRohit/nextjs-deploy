					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar expand="lg" className="navbar navbar-expand-lg bg-light">
								<Container fluid>
									<Navbar.Brand>
										<Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" className="d-inline-block align-text-top" />
									</Navbar.Brand>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar className="navbar bg-light mb-3">
								<Container fluid>
									<Link href="#!" className="navbar-brand"><Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" /></Link>
								</Container>
							</Navbar>
							<Navbar className="navbar bg-light">
								<Container fluid>
									<span className="navbar-brand mb-0 h1"><Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" /></span>
								</Container>
							</Navbar>
						</Card.Body>
					</Card>
							...
							<Navbar className="navbar bg-light">
								<Container fluid>
									<Navbar.Brand className="navbar-brand">
										<Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" width="24"
				...
				<Col xl={12}>
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar className="navbar bg-light mb-3">
								<Container fluid>
									<Navbar.Brand>  <Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" /></Navbar.Brand>
									<Form className="d-flex" role="search">
										<Form.Control className="me-2" type="search" placeholder="Search"
											aria-label="Search" />
										<Button variant='primary' className="btn btn-primary" type="submit">Search</Button>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary-transparent mb-3">
								<Container fluid>
									<Navbar.Brand className="navbar-brand">  <Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-dark-transparent">
								<Container fluid>
									<Navbar.Brand href='#!' className="navbar-brand">  <Image src="../../../assets/images/brand-logos/toggle-logo.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-primary mb-3">
								<Container fluid>
									<Navbar.Brand>
										<Image src="../../../assets/images/brand-logos/toggle-dark.png" alt="" />
									</Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary mb-3">
								<Container fluid>
									<Navbar.Brand href='#!'>  <Image src="../../../assets/images/brand-logos/toggle-dark.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
						...
						<Card.Body>
							<Navbar expand={false} className="navbar bg-light fixed-top">
								<Container fluid>
									...
									<Navbar.Toggle aria-controls="offcanvasNavbar-expand-false" className='dark-filter-Image' />
									<Navbar.Offcanvas
...
NavbarMain.layout = "Contentlayout"
