...
import { DrinkTable, IndividualTable } from "@/shared/data/tables/datatablesdata";
                ...
                <Card>
                    <Tab.Container id="left-tabs-example" defaultActiveKey="AllProducts">
                        <Card.Header className='d-md-flex justify-content-between'>
                            <h4 className="card-title p-2">Documentation - Individual Activity</h4>
                        </Card.Header>
                        <Card.Body>
                            <Row>
                                <Col>
                                    <GenericDropDown selectedItems={selectedItems} handleClick={handleClick} dropdownData={childData} label="Individual Activity" />
                                </Col>
                                <Col>
                                </Col>
                                <Col>
                            ...
                            <IndividualTable addNewRow={false} header={individualHeader} actions/>
...
Individual.layout = "Contentlayout";